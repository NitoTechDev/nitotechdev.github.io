...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const blogHeadings = blogContainer.querySelectorAll("h1, h2, h3"); // Gets the h1 - h3 headings. 
        ...
        switch (heading.level) {
            ...
            case "2":
                ...
                if (hasSubheading) {
                    ...
                    // mostRecentDetails.open = true; // May have to remove later.
                    const summary = document.createElement("summary");
                    tocListContainer.appendChild(li);
                    li.appendChild(mostRecentDetails);
                    summary.textContent = heading.text;
